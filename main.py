...
class Software(QMainWindow,Ui_MainWindow):
    ...
    def selected_Row(self):
        ...
        if row_selected:
            ...
            self.categorie_cb.setCurrentIndex(int(row_selected[3]))
            self.phone_field.setText(row_selected[4])
            self.nationalid_field.setText(row_selected[5])
            self.status_cb.setCurrentIndex(int(row_selected[6]))
